  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "X-Debug is an AI-powered reverse debugger for Python and C. Static analysis, ML defect scoring, causal graphs, ranked AI fixes, and a safe git-branch sandbox.",
      },
      { name: "author", content: "X-Debug" },
      { name: "theme-color", content: "#1f2733" },
      { property: "og:title", content: "X-Debug — AI Reverse Debugger for Python & C" },
      {
        property: "og:description",
        content:
          "Static analysis, ML defect scoring, causal-graph visual debugging, and ranked AI fixes in a safe sandbox.",
      },
